...
{
    public partial class _180422_2200 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuthorCountry = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookCount = table.Column<int>(type: "integer", nullable: true),
                    BookDescription = table.Column<string>(type: "text", nullable: true),
                    BookAgeRestriction = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EditionPublication = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    EditionLength = table.Column<int>(type: "integer", nullable: true),
                    EditionType = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GenreToBooks", x => x.Id);
                    table.ForeignKey(
